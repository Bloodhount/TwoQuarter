...
namespace Asteroids.Interpreter
{
    public class InterpreterScores : MonoBehaviour
    {
        ...
        public void Interpret(long value)
        {
            ...
            _textAddScore.text = "<color=yellow> + </color>" + $"<color=green> {value}</color>";                     // ѕример таймера https://www.youtube.com/watch?v=XnHpJAb7yh0&list=PLKWKqJ1bWRh72mlJX-V_mt1bItUy2aSBu&index=15
